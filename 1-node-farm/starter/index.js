...
const replaceTemplate = require('./modules/replaceTemplate'); //包之间使用/ 间隔，并且没有.js
// 你引入了这个modules之后，想叫什么名字都OK。
...
const server = http.createServer((req, res) => {
  ...
  if (pathname === '/' || pathname === '/overview') {
    //这里是真尼玛神奇了，不能用pathName，只能用小写的？？我盲猜是因为名字会重复？
    res.writeHead(200, {
    ...
    const cardsHtml = dataObj
      ...
      .join(''); //We use join('') in order to make tempCard to be a real string
